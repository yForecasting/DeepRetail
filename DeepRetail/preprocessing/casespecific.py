# Functions for each specific case

from DeepRetail.preprocessing.converters import remove_gifts, fix_duplicate_cols
...
def read_case_3(read_filepath, calendar_filepath):
    """Reads data for case 1

    Args:
        read_filepath (str): Existing loocation of the data file
        calendar_filepath (str): Existing loocation of the calendar file.
...
def read_case_6(read_filepath):
    ...
    df["FullOrder"] = [re.sub("\D", "", d) for d in df["ORDERNR"]]
